                            ...
                            <div class="kt-portlet__body">
                                <div class="kt-section kt-section--first">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" value="{{$data['nama']}}" name="nama" placeholder="Masukkan Nama Banner" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <a href="{{asset("uploads/banner/$data[file]")}}" target="_blank"><img src="{{asset("uploads/banner/$data[file]")}}" width="100%" alt=""></a>
                                            <span class="form-text text-muted">Preview Gambar Banner</span>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="url" class="form-control" value="{{$data['url']}}" name="url" placeholder="Masukkan Url Banner">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" value="{{$data['phone']}}" name="phone" placeholder="Masukkan No Telp">
                                    ...
                                    <div class="form-group row" id="showconf" {{empty($data['confirmation']) ?"style=display:none": '' }}>
                                        <label class="col-lg-3 col-form-label"> Confirmation Message :</label>
                                        <div class="col-lg-6">
                                            <textarea type="url" class="form-control" name="confirmation" placeholder="Masukkan Isi Konfirmasi Banner">{{$data['confirmation']}}</textarea>
