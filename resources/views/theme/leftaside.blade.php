            ...
            <ul class="kt-menu__nav ">
                ...
                <li class="kt-menu__item {{Request::url() == url("/products") ? "kt-menu__item--active" : ""}}"
                    aria-haspopup="true"><a href="{{url('/products')}}" class="kt-menu__link "><span
                        ...
                        <span class="kt-menu__link-text"> Products</span></a></li>
                @if(Session::get('level') == 3)
                <li class="kt-menu__item {{Request::url() == url("/pushnotif") ? "kt-menu__item--active" : ""}}"
                    aria-haspopup="true"><a href="{{url('/pushnotif')}}" class="kt-menu__link "><span
                                class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                                height="24px" viewBox="0 0 24 24" version="1.1"
                                                                class="kt-svg-icon">
											...
											</svg></span><span class="kt-menu__link-text"> Push Notifications</span></a></li>
                <li class="kt-menu__item {{Request::url() == url("/logs") ? "kt-menu__item--active" : ""}}"
                    aria-haspopup="true"><a href="{{url('/logs')}}" class="kt-menu__link "><span
                                class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                                height="24px" viewBox="0 0 24 24" version="1.1"
                                                                class="kt-svg-icon">
                ...
                @endif
                <li class="kt-menu__item {{Request::url() == url("/settings") ? "kt-menu__item--active" : ""}}"
                    aria-haspopup="true"><a href="{{url('/settings')}}" class="kt-menu__link "><span
                                class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                                height="24px" viewBox="0 0 24 24" version="1.1"
                                                                class="kt-svg-icon">
                    ...
                    </svg></span><span class="kt-menu__link-text"> Settings</span></a></li>
                <li class="kt-menu__item {{Request::url() == url("/feedback") ? "kt-menu__item--active" : ""}}"
                    aria-haspopup="true"><a href="{{url('/feedback')}}" class="kt-menu__link "><span
                                class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                                height="24px" viewBox="0 0 24 24" version="1.1"
                                                                class="kt-svg-icon">
                    ...
                    </svg></span><span class="kt-menu__link-text"> Feedback</span></a></li>
                <li class="kt-menu__item {{Request::url() == url("/message") ? "kt-menu__item--active" : ""}}"
                    aria-haspopup="true"><a href="{{url('/message')}}" class="kt-menu__link "><span
                                class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                                                                height="24px" viewBox="0 0 24 24" version="1.1"
                                                                class="kt-svg-icon">
